...
function cargarArreglo() {
    const codigo = parseInt(document.getElementById('codigoInventario').value);
    ...
    const articuloExistente = inventario.find(item => item.codigo === codigo);
    
    if (articuloExistente) {
        articuloExistente.entradas += entradasValue;
        articuloExistente.salidas += salidasValue;
        articuloExistente.stock = articuloExistente.stock + entradasValue - salidasValue;
    } else {
        inventario.push({ 
            codigo, 
            articulo, 
...
function actualizarInventario() {
    ...
    if (articulo) {
        articulo.articulo = document.getElementById('productoInventario').value;
        articulo.entradas = parseFloat(document.getElementById('entradas').value);
        articulo.salidas = parseFloat(document.getElementById('salidas').value);
        articulo.stock = articulo.stock + articulo.entradas - articulo.salidas; 
        ...
        Swal.fire({
            position: "top-end",
            icon: "success",
            title: "Articulo encontrado y actualizado",
        ...
        Swal.fire({
            icon: "error",
            title: "Oops...",
            text: "¡Artículo no encontrado para actualizar!",
        });
    }
}
